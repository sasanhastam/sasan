...
💎Sudoer And Admins sasan Bot Help :💎
...
*🌼شما میتوانید از دستورات استقاده کنید🌼 ;)*]]..msg_caption
tdcli.sendMessage(msg.chat_id_, 0, 1, text, 1, 'md')
else

text = [[
💎⚙️راهنمای استفاده از ربات ساسان⚙️:💎
...
🔥🌈⭕️👆🏻👉🏻autoleave🔥 `[disable/enable/status]`
💎خروج خودکار💎
...
text = [[
  ...
  🌈⭕️👆🏻👉🏻⚙️راهنمای استفاده از ربات ساسان⚙️:  🌈⭕️👆🏻👉🏻
